...
------------------------------------- */
    ...
    @media all {
      .btn-primary table td:hover {
        background-color: #ec6a07 !important;
      }
      .btn-primary a:hover {
        background-color:  #ec6a07 !important;
        border-color:  #ec6a07 !important;
      }
    }
          ...
          <div class="content">
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main">
              ...
              <tr>
                <td class="wrapper">
                  <h3>¡Bienvendio!</h3>
                  <p>Se ha registrado la cuenta con exito, solo te falta un paso que es verificar tu cuenta de correo, para que sea activa la cuenta.</p>
